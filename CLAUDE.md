...
- Wochenansicht: leere Nachtstunden sind eingeklappt — das Raster beginnt um 08:00 bzw. zur vollen Stunde des frühesten Zeit-Termins der Woche (`gridStartHour` in week-view.js); kein Initial-Scroll mehr.
