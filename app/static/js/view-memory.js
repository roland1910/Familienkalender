...
// (calendar/power/weather/groundwater) survive a reload. Kiosk and browser
// each keep their own state — localStorage is per device/browser by design.
//
...
const MODES = new Set(["calendar", "power", "weather", "groundwater"]);
